...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `<h2 class="title-2" aria-labelledby="highlights-label">
      Todays Highlights
    </h2>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      /* 5 day's forecast section */
      forecastSection.innerHTML = `<h2 class="title-2" id="forecast-label">5-Day Forecast</h2>
...
export const error404 = () => style.display.flex;
