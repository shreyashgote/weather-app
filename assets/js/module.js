 ...
 * @returns {number} kmh kilometer per hour
 */
...
export const aqiText = {
  ...
  2: {
    level: "Fair",
    message:
      "Air quality is acceptable; however for some pollutants there may be moderate health concern for very small number of people who are unusally sensitive to air polltion",
  },
  3: {
    level: "Moderate",
    message:
